...
"""
================================================================
search_and_summarize 补搜功能 · 隔离网络集成测试（v2.0）
search_and_summarize Refinement Test - Isolated Network Integration (v2.0)
================================================================
设计：                          |  Design:
...
v2.0 修复：                     |  v2.0 Fixes:
  ✓ fake_search 第1次只返回干扰站 | ✓ fake_search: round 1 returns only noise sites
  ✓ 验证逻辑兼容千分位逗号       | ✓ Validation handles thousand separators
  ✓ 干扰站删减为 13 个          | ✓ Reduced noise sites to 13
